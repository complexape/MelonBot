...
namespace SharkBot.Helpers
{
    public class ImageHelper
    {
        public static IImageProcessingContext ApplyScalingWaterMarkSimple(IImageProcessingContext processingContext, Font font, string text, Color color, float padding)
        {
        ...
        public static IImageProcessingContext ApplyScalingWaterMarkWordWrap(IImageProcessingContext processingContext,
            Font font,
            string text,
            Color color,
            float padding)
